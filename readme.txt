...
Override the default From: 'WordPress <wordpress@mydomain.com>' name and email address.
...
= 1.2.1 =
* Yep, it still works with WordPress 5.9

= 1.2 =
* Plugin maintainer changed
* Tweak: update admin settings page
* Fix: replace deprecated function calls, other small compatibility fixes
* Fix: code rewrite and indentation cleanup
